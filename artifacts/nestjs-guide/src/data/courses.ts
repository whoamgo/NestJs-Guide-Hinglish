...
export const courses: CourseInfo[] = [
  ...
  },
  {
    ...
    description: "Browser ki language — variables se async/await tak, DOM se classes tak A to Z",
    level: "Beginner",
    topics: ["Variables", "Functions", "DOM", "Events", "Promises", "ES6+", "Classes", "Modules"],
    totalChapters: 11,
    totalInterviews: 6,
  },
  {
  ...
  },
  {
    ...
    level: "Beginner",
    topics: ["Modules", "Express.js", "Async/Await", "Streams", "Security", "Auth", "PM2"],
    totalChapters: 8,
    totalInterviews: 20,
  },
  {
    ...
    level: "Intermediate",
    topics: ["JSX", "Hooks", "State", "Context", "Router", "Forms", "Zustand"],
    totalChapters: 8,
    totalInterviews: 20,
  },
  {
